...
public class ContactApp {
                ...
                while(workingOnList == true) {
                    ...
                    switch (selection) {
                        ...
                        case 2:
                            ...
                            try{
                                list.addItem(fname, lname, phone, email);
                        ...
                        case 3:
                            list.viewList();
                            System.out.println("Which task do you want to edit? (enter number or -1 to exit):");
                            int edit = 0;
                            valid = false;
                            while(!valid){
                                try {
                                    ...
                                    if(edit == -1){
                                        ...
                                        email = scan.nextLine();
                                        try{
                                            list.setEditItem(edit, fname, lname, phone, email);
                                        }catch(InputMismatchException e){
                                            e.printStackTrace();
                                        }
                        ...
                        case 4:
                            ...
                            list.viewList();
                            System.out.println("Which contact do you want to remove? (enter number):");
                            int remove = 0;
                            try {
                                remove = scan.nextInt();
                                scan.nextLine();
    ...
    public static ContactList newList(){

        ContactList list = new ContactList();
        System.out.println("Contact list has been created.");
        return list;
